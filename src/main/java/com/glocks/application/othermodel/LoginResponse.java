package com.glocks.application.othermodel;
...
public class LoginResponse {
    ...
    public LoginResponse(String response, Integer statusCode, String username, long userId,
    ...
    public LoginResponse(String response, Integer statusCode, String username, long userId, String name, String primaryRole, long primaryRoleId, String status, String operatorTypeName, Integer operatorTypeId, String userLanguage, String period, Integer statusValue, String password) {
        super();
        this.response = response;
        this.statusCode = statusCode;
        this.username = username;
    ...
    public LoginResponse(String response, Integer statusCode, String username, long userId, String name, String primaryRole, long primaryRoleId, String status, String operatorTypeName, Integer operatorTypeId, String userLanguage, String period, Integer statusValue, String password, Integer selfRegister) {
        super();
        this.response = response;
        this.statusCode = statusCode;
        this.username = username;
