...
import com.glocks.application.othermodel.AllRequest;
...
public class UserDetails extends AllRequest {
	...
	public UserDetails(String firstName, String middleName, String lastName,
			String phoneNo, String email,String userName, long id, String remarks, String approvedBy, Integer currentStatus) {
		super();
		this.firstName = firstName;
			this.middleName = middleName;
			this.lastName = lastName; 
