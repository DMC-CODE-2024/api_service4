...
import com.ceir.CeirCode.othermodel.SearchCriteria;
        ...
        try {
            for (SearchCriteria searchCriteria : criterias) {
                specifications.add((root, query, cb) -> {
                    ...
                    if (SearchOperation.GREATER_THAN.equals(searchCriteria.getSearchOperation()) && Datatype.STRING.equals(searchCriteria.getDatatype())) {
                    ...
                    } else if (SearchOperation.EQUALITY.equals(searchCriteria.getSearchOperation()) && Datatype.INTEGER.equals(searchCriteria.getDatatype())) {
                    ...
                    } else if (SearchOperation.EQUALITY.equals(searchCriteria.getSearchOperation()) && Datatype.DOUBLE.equals(searchCriteria.getDatatype())) {
                        ...
                        if (searchCriteria.getKey().contains("-")) {
                            ...
                            if (key.length == 2) {
                                ...
                                return cb.like(cb.lower(root.join(key[0]).get(key[1]).get(key[2]).as(String.class)), "%" + ((String) searchCriteria.getValue()).toLowerCase() + "%");
                            }
                        } else {
                            return cb.like(cb.lower(root.get(searchCriteria.getKey()).as(String.class)), "%" + ((String) searchCriteria.getValue()).toLowerCase() + "%");
                        }
                    } else if (SearchOperation.LIKE.equals(searchCriteria.getSearchOperation()) && Datatype.DOUBLE.equals(searchCriteria.getDatatype())) {
        ...
        try {
            for (SearchCriteria searchCriteria : criterias) {
                specifications.add((root, query, cb) -> {
                    ...
                    Join<UserProfile, User> user = root.join("user".intern());
                    if (SearchOperation.LIKE.equals(searchCriteria.getSearchOperation()) && Datatype.STRING.equals(searchCriteria.getDatatype())) {
